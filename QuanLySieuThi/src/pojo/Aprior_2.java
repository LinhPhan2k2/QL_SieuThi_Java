 ...
 * @author LinhPTA-PC
 */
public class Aprior_2 {
    
    
    
    public static ArrayList<ArrayList<String>> ListDX()
    {
             ArrayList<ArrayList<String>> dexuat = new ArrayList<ArrayList<String>>();
		...
		ArrayList<ArrayList<String>> prevItemSetsWithMinSupportCount = new ArrayList<ArrayList<String>>();  
                // transactions=CT_PhieuNhapDAO.layDSMaHH();
                //_transactions=CT_PhieuNhapDAO.layDSMaHH();
                
                
                transactions=ThongKe_HD_DAO.layDSMaHH();
                _transactions=ThongKe_HD_DAO.layDSMaHH();
		System.out.print("Minumum support count: ");
		int minSupportCount = 6;
		...
		while (true) {
			...
			if (itemSetsWithMinSupportCount.size() == 0) {
				...
				dexuat = prevItemSetsWithMinSupportCount;
